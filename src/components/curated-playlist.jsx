...
const CuratedPlaylist = () => {
    ...
    return (
        <div className="bg-[#609EAF] overflow-hidden relative w-full h-[500px] px-8 py-8 flex flex-col justify-between rounded-[20px] text-white">
            ...
            <img src={ wave } alt="wave" className="absolute rotate-[90deg] top-[-25%] right-[-25%]" />
        </div>
    )
}
